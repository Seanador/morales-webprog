    ...
    <>
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={2} sx={{ mb: 4 }}>
        <Gauge
          ...
          value={60}
          sx={{
            "& .MuiGauge-valueArc": { fill: TEAL_600 },
            "& .MuiGauge-referenceArc": { fill: CYAN_100 },
          }}
        />
        <Gauge
          width={100}
          ...
          valueMax={60}
          sx={{
            "& .MuiGauge-valueArc": { fill: TEAL_800 },
            "& .MuiGauge-referenceArc": { fill: CYAN_100 },
          }}
        />
      </Stack>
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={2} sx={{ mb: 4 }}>
        ...
        <PieChart
          series={[
            {
              data: [
                { id: 0, value: 10, label: "series A", color: TEAL_600 },
                { id: 1, value: 15, label: "series B", color: TEAL_800 },
                { id: 2, value: 20, label: "series C", color: CYAN_100 },
              ],
            },
          ]}
          width={400}
        ...
        >
          ...
          <Marker position={[14.604215, 120.994314]}>
            <Popup>
              ...
              <p>551 F Jhocson St, Sampaloc, Manila</p>
            </Popup>
          </Marker>
        </MapContainer>
      </Box>
